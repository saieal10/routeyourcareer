...
function MultiChoice({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`
        rounded-full px-4 py-2.5 text-[12px] font-semibold
        border transition
        ${
          active
...
export default function BuildMyRoute() {
  ...
  const [rycCourses, setRycCourses] =
    useState([]);
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
            ...
            <div className="max-w-4xl">
              ...
              <p className="mt-6 max-w-3xl text-[15px] sm:text-[17px] text-ink/65 leading-relaxed">
                ...
                This is not an application form and it is not designed to push
                you toward a particular university.

                Tell us about your education, interests, work style and
                priorities. We will first identify career paths that fit you.
              ...
              <div className="mt-7 rounded-2xl border border-forest/20 bg-forest/5 p-4 max-w-2xl">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-[12px] text-ink/60 leading-relaxed">
                    ...
                    Route Your Career programmes are shown only after your
                    career recommendations are generated.

                    A career can still be recommended even if RYC does not
                    currently offer that programme.
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        ...
        {step === 3 && (
          ...
          <section className="max-w-4xl mx-auto">
            ...
            <p className="mt-3 text-[13px] text-ink/55">
              Choose as many as you genuinely like. There is no right answer.
            </p>
        ...
        {step === 4 && (
          ...
          <section className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 space-y-4">
              ...
              {WORK_STYLE_QUESTIONS.map(question => (
                    ...
                    {[1, 2, 3, 4, 5].map(value => {
                      ...
                      return (
                        ...
                        <button
                          ...
                          className={`
                            h-10 w-10 rounded-full border text-[12px] font-semibold transition
                            ${
                              active
                                ? 'bg-ink text-cream border-ink'
        ...
        {step === 5 && (
          ...
          <section className="max-w-4xl mx-auto">
            ...
            <p className="mt-3 text-[13px] text-ink/55">
              Select the things that genuinely matter to you.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-ink/50 mt-1 leading-relaxed">
                    Budget and location preferences help with practical planning.
                    They do not change which career is considered more profitable
                    for Route Your Career.
                  </p>
        ...
        {step === 7 && (
          ...
          <section>
              ...
              <div className="flex flex-wrap items-end justify-between gap-6">
                ...
                <div>
                  ...
                  <p className="mt-4 max-w-3xl text-[13px] sm:text-[14px] leading-relaxed text-cream/65">
                    ...
                    These results are guidance, not a psychological aptitude
                    diagnosis.

                    They are based on the interests, academic background,
                    work-style preferences and priorities you entered.
            ...
            {selectedCareer && (
              ...
              <div className="mt-10 rounded-[30px] border border-ink/10 bg-white overflow-hidden">
                ...
                <div className="p-6 sm:p-8 border-b border-ink/10">
                  ...
                  <h2 className="serif text-4xl mt-2">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  {selectedCareer.ryc_tags?.length === 0 && (
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-[12px] text-ink/55 leading-relaxed">
                            Route Your Career does not currently have a dedicated
                            programme catalogue for this pathway.

                            We are still showing it because it may genuinely fit
                            your profile.
                          </p>
                  ...
                  {selectedCareer.ryc_tags?.length > 0 && (
                    ...
                    <>
                      ...
                      <p className="mt-2 text-[12px] text-ink/50">
                        These options are shown after the career recommendation.
                        They did not influence your career-fit score.
                      </p>
                      ...
                      {!loadingCourses &&
                       ...
                       rycCourses.length === 0 && (
                        ...
                        <div className="mt-6 rounded-2xl bg-cream p-5 text-[12px] text-ink/50">
                          There are currently no published RYC programmes matching this pathway.
                        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[11px] text-ink/55 leading-relaxed max-w-3xl">
                    ...
                    Talk to people working in the careers you are considering,
                    research course requirements, understand costs and licensing,
                    and discuss major decisions with your family or a qualified
                    career counsellor.
