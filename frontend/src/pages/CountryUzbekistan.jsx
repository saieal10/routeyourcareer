...
import { uzbekistanData } from '../data/uzbekistan';
...
export default function CountryUzbekistan() {

  const d = uzbekistanData;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-3 gap-3">
          ...
          {d.gallery.map((g, i) => (
            ...
            <img
              key={i}
              src={g}
              alt={`Uzbekistan medical university ${i + 1}`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-ink/70 text-[15px] leading-relaxed max-w-md">
              ...
              Check the basic admission requirements before choosing
              your Uzbekistan medical university.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-ink/70 text-[15px] leading-relaxed max-w-md">
              ...
              Compare tuition alongside hostel, food, immigration,
              travel and other academic expenses.
              ...
              <div className="divide-y divide-ink/10">
                ...
                {d.feeBreakdown.map((r) => (
                  ...
                  >
                    ...
                    <div className="mt-1 sm:mt-0 serif text-[19px] font-medium sm:text-right">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-5">
            ...
            {d.universities.map((u, i) => (
              ...
              <div
                key={u.name}
                className="group rounded-3xl overflow-hidden bg-white border border-ink/10 card-lift flex flex-col"
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <h3 className="mt-3 serif text-[24px] font-medium leading-tight">
                  ...
                  <div className="mt-auto pt-5 flex items-end justify-between gap-3">
                    ...
                    <div>
                      ...
                      <div className="serif text-[18px] font-medium">
