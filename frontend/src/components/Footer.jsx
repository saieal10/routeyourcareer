            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[10px] mono uppercase tracking-[0.22em] text-coral">
                  Is your pathway · MBBS Abroad
                </div>
              </div>
            </div>

            <p className="mt-6 text-[14px] leading-relaxed max-w-md text-cream/60">
              Route Your Career is your pathway — a young guidance &amp;
              lead-generation platform helping Indian students find their
              dream MBBS university across nine countries, with a special
              focus on Georgia and Uzbekistan.
            </p>
