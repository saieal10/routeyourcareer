      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
        <div className="grid lg:grid-cols-12 gap-8 items-end">
          <div className="lg:col-span-7">
            ...
            <h2 className="serif mt-3 text-5xl sm:text-6xl font-normal leading-[0.95] text-ink">Five states.<br/><em className="font-light">One doctor promise.</em></h2>
          </div>
          <p className="lg:col-span-5 text-ink/70 text-[15px] leading-relaxed">
            RYC is present across five South-Indian states — Karnataka, Maharashtra, Kerala, Tamil Nadu and Telangana. Every counsellor you meet is an MBBS doctor.
          </p>
        </div>
          ...
          {offices.map((o, i) => (
            <a href="#" key={o.city} className="group relative rounded-3xl overflow-hidden bg-white border border-ink/10 card-lift">
              <div className="relative aspect-[3/4] overflow-hidden">
                <img src={o.img} alt={o.state} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 text-cream">
                  <div className="serif text-3xl font-medium leading-tight">{o.state}</div>
                  <a href={`tel:${brand.phone}`} className="mt-3 inline-flex items-center gap-1 text-[12px] font-semibold text-coral">
